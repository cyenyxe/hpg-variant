...
void epistasis_report(int order, int cv_repetition, enum evaluation_mode mode, enum evaluation_subset subset, 
    ...
    show_cross_validation_arguments(cv_repetition, order, mode, subset, stdout);
    show_cross_validation_best_models(order, best_models, max_ranking_size, cmp_heap_max, stdout);
}
